...
const socket=useSocket()
     ...
     useEffect(() => {
            ...
            socket.on("new-user-joined", handleJoinRoom);
            return () => {
                socket.off("new-user-joined", handleJoinRoom);
            };
        }, [socket,]);
    return (<div>
        <h1> rome</h1>
...
export default function VideoMeetComponent() {
    ...
    console.log('UUUU', socketRef.current)
    ...
    let connectToSocketServer = () => {
        ...
        socketRef.current.on("connect", () => {
            socketRef.current.emit("join-call", { romeId: romeId });
            ...
            socketRef.current.on("user-joined", (data) => {
                ...
                data.connectionsSocketIds.forEach((socketListId) => {
